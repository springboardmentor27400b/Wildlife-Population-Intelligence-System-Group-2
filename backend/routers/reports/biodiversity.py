...
# =========================================================
# BUILD BIODIVERSITY SPECIES REPORT
# =========================================================

def build_biodiversity_species_report(
    db: Session,
    species: models.Species
):
    """
    Build common biodiversity report structure
    for one species.
...
def get_biodiversity_report(
    ...
    for species in species_list:
        ...
        report = build_biodiversity_species_report(
            db,
            species
        )
...
# =========================================================
# =========================================================
# ALL BIODIVERSITY EXPORTS
# =========================================================
# =========================================================


# =========================================================
# ALL BIODIVERSITY - PDF
#
# /reports/biodiversity/all/pdf
# =========================================================

@router.get("/biodiversity/all/pdf")
def export_all_biodiversity_pdf(
    db: Session = Depends(get_db),
    current_user: models.User = Depends(get_current_user),
):

    print(
        "========== ALL BIODIVERSITY PDF EXPORT =========="
    )
    ...
    elements.append(
        Paragraph(
            "<b>Overall Biodiversity Summary</b>",
            styles["Heading2"]
        )
    )
    ...
    if len(status_rows) == 1:
        ...
        status_rows.append([
            "No conservation statuses available"
        ])
    ...
    elements.append(
        Paragraph(
            "<b>Species Biodiversity Overview</b>",
            styles["Heading2"]
        )
    )
    ...
    print(
        "All biodiversity PDF generated successfully."
    )
    ...
    return StreamingResponse(
        ...
        headers={
            "Content-Disposition":
                'attachment; '
                'filename="all_biodiversity_report.pdf"'
        }
    )


# =========================================================
# ALL BIODIVERSITY - EXCEL
#
# /reports/biodiversity/all/excel
# =========================================================

@router.get("/biodiversity/all/excel")
def export_all_biodiversity_excel(
    db: Session = Depends(get_db),
    current_user: models.User = Depends(get_current_user),
):

    print(
        "========== ALL BIODIVERSITY EXCEL EXPORT =========="
    )
    ...
    print(
        "All biodiversity Excel generated successfully."
    )
    ...
    return StreamingResponse(
        ...
        headers={
            "Content-Disposition":
                'attachment; '
                'filename="all_biodiversity_report.xlsx"'
        }
    )


# =========================================================
# ALL BIODIVERSITY - CSV
#
# /reports/biodiversity/all/csv
# =========================================================

@router.get("/biodiversity/all/csv")
def export_all_biodiversity_csv(
    db: Session = Depends(get_db),
    current_user: models.User = Depends(get_current_user),
):

    print(
        "========== ALL BIODIVERSITY CSV EXPORT =========="
    )
    ...
    print(
        "All biodiversity CSV generated successfully."
    )
    ...
    return StreamingResponse(
        ...
        headers={
            "Content-Disposition":
                'attachment; '
                'filename="all_biodiversity_report.csv"'
        }
    )
...
# =========================================================
# =========================================================
# SINGLE BIODIVERSITY EXPORTS
# =========================================================
# =========================================================


# =========================================================
# SINGLE BIODIVERSITY SPECIES REPORT
# =========================================================

@router.get("/biodiversity/{species_id}")
def get_single_biodiversity_report(
    species_id: int,
    db: Session = Depends(get_db),
    current_user: models.User = Depends(get_current_user),
):
    ...
    return {
        ...
        **build_biodiversity_species_report(
            db,
            species
        )
    }
...
# =========================================================
# SINGLE BIODIVERSITY - PDF
#
# /reports/biodiversity/{species_id}/pdf
# =========================================================

@router.get("/biodiversity/{species_id}/pdf")
def export_single_biodiversity_pdf(
    species_id: int,
    db: Session = Depends(get_db),
    current_user: models.User = Depends(get_current_user),
):
...
# =========================================================
# SINGLE BIODIVERSITY - EXCEL
#
# /reports/biodiversity/{species_id}/excel
# =========================================================

@router.get("/biodiversity/{species_id}/excel")
def export_single_biodiversity_excel(
    species_id: int,
    db: Session = Depends(get_db),
    current_user: models.User = Depends(get_current_user),
):
...
# =========================================================
# SINGLE BIODIVERSITY - CSV
#
# /reports/biodiversity/{species_id}/csv
# =========================================================

@router.get("/biodiversity/{species_id}/csv")
def export_single_biodiversity_csv(
    species_id: int,
    db: Session = Depends(get_db),
    current_user: models.User = Depends(get_current_user),
):
